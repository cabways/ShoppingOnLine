  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="changeTrademark(trademark)">{{trademark.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
    ...
    <div class="type-wrap" v-for="attr in attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue,index) in attr.attrValueList" :key="index" @click="changeDisposition(attr,attrValue)">
            <a>{{attrValue}}</a>
          </li>
        </ul>
      </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      //配置事件处理函数
      changeDisposition(attr,attrValue){
        this.$emit('disposition',attr,attrValue)
      }
    }
  }
</script>
...
<style scoped>
   ...
   /*鼠标悬浮样式*/
   .selector .type-wrap .value .logo-list li:hover{
     cursor: pointer;
   }
